...
function get_settings() {
	$defaults = [
		...
		'enable_tts'          => true,
		'tts_disclosure'      => 'The voice you are hearing is generated by AI technology, not a human.',
		'tts_model'           => 'tts-1-hd',
		'tts_voice'           => 'alloy',
	];
...
function get_license_status_message() {
	...
	$message = esc_html__( 'Unknown licensing error, please try again later!', 'handywriter' );
