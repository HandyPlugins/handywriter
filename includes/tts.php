...
function create_audio_callback() {
	...
	$audio_request_args = apply_filters( 'handywriter_audio_request_args', [
	...
	if ( isset( $response['data']['audio_data'] ) ) {
		$audio_data = base64_decode( $response['data']['audio_data'] );
		$post_id = 0;
		...
		$attachment_id = media_handle_sideload( $file_array, $post_id, null, ['post_excerpt' => 'Audio generated by AI - Handywriter']  );
